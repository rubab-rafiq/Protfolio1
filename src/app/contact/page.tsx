...
// const Contact = () => {
//   return (
//     <section className="bg-[#350e45] text-white py-16 px-6 lg:px-20">
...
//       {/* Contact Form */}
//       <div className="max-w-2xl mx-auto mt-10 bg-zinc-400 p-8 rounded-lg shadow-lg">
//         <form className="space-y-6">
//           <div className="flex items-center bg-gray-500 rounded-lg p-3">
...
//         <a href="#" className="text-blue-400 text-3xl hover:scale-110 transition-all duration-300">
//           <FaLinkedin />
//         </a>
//         <a href="#" className="text-white text-3xl hover:scale-110 transition-all duration-300">
//           <FaGithub />
//         </a>
//         <a href="#" className="text-blue-600 text-3xl hover:scale-110 transition-all duration-300">
//           <FaFacebook />
//         </a>
//         <a href="#" className="text-blue-400 text-3xl hover:scale-110 transition-all duration-300">
//           <FaTwitter />
